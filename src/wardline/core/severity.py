...
class RuleId(StrEnum):
    ...
    WARDLINE_DYNAMIC_IMPORT = "WARDLINE-DYNAMIC-IMPORT"
    ...
    GOVERNANCE_TAINT_DEGRADED = "GOVERNANCE-TAINT-DEGRADED"
    GOVERNANCE_TAINT_CONFLICT = "GOVERNANCE-TAINT-CONFLICT"
    GOVERNANCE_RESTORATION_OVERCLAIM = "GOVERNANCE-RESTORATION-OVERCLAIM"
    GOVERNANCE_MODULE_TIERS_BLANKET = "GOVERNANCE-MODULE-TIERS-BLANKET"
    GOVERNANCE_MODULE_TIERS_UNDECORATED = "GOVERNANCE-MODULE-TIERS-UNDECORATED"
    GOVERNANCE_CUSTOM_KNOWN_VALIDATOR = "GOVERNANCE-CUSTOM-KNOWN-VALIDATOR"
    GOVERNANCE_FILE_SKIPPED = "GOVERNANCE-FILE-SKIPPED"
